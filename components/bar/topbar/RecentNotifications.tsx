...
import { markAllNotificationsRead, markNotificationRead } from '@/redux/slices/notificationSlice';
    ...
    <Dropdown
      ...
      label={
        <div className="relative">
          <HiBell className="w-10 h-10 p-2 text-gray-500 rounded-full border border-gray-300 
      ...
      {instantNotificationLoading ? (
        ...
        <>
          ...
          <div className="flex items-center justify-between bg-gray-50 dark:bg-gray-600 mt-4">
            ...
            <Dropdown.Item
              onClick={() => dispatch(markAllNotificationsRead({ business_id: org?.id }))}
