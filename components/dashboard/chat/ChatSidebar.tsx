...
import { ChatReadStatus, cn, SystemRole } from '@/lib/utils';
    ...
    <>
      ...
      <Card className={cn(
        ...
        {profile?.role.role_id !== SystemRole.USER && (
          <Button onClick={() => setOpen(true)} className='h-10 text-xs font-bold mb-4'> Create Group </Button>
        )}
      ...
      <CreateTeamChat token={token || null} open={open} setOpen={setOpen} />
